...
class MLPtensor(nn.Module):
    def __init__(self, dim_in, dim_hidden, dim_out):
        super(MLPtensor, self).__init__()
        self.layer_input = nn.Linear(dim_in, 500)
        self.relu = nn.ReLU()
        #self.dropout = nn.Dropout(0.2)
        self.layer_hidden1 = nn.Linear(500, 100)
        self.layer_hidden2 = nn.Linear(100, 10)
        self.layer_out = nn.Linear(10, dim_out)
