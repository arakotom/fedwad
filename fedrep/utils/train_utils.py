...
from models.Nets import CNNCifar, CNNCifar100, RNNSent, MLP, MLPtensor
...
def get_model(args):
    ...
    elif args.model == 'mlp' and 'tensor' in args.dataset:
        net_glob = MLPtensor(dim_in=4, dim_hidden=50, dim_out=args.num_classes).to(args.device)
